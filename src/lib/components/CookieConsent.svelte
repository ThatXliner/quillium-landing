...
{#if visible}
	...
	>
		<p class="m-0 mb-4 text-sm leading-relaxed text-black/60 contrast-more:text-black/70 sm:text-[0.8rem]">
		...
		<div class="flex gap-2">
			...
			<button
				onclick={decline}
				class="min-h-[44px] rounded-full bg-black/[0.04] px-5 py-2 text-[0.75rem] font-medium text-black/50 contrast-more:text-black/60 transition-colors hover:bg-black/[0.08] hover:text-black/70 contrast-more:hover:text-black/80 sm:min-h-0"
			>
				Decline
			</button>
		</div>
