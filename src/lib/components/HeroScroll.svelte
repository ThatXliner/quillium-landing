<script lang="ts">
  ...
  onMount(() => {
    ...
    // Phase 3→4: Inline → Library/Safety
...
<section class="hero-scroll">
  ...
  <div class="stage" id="hero-scroll-stage">
    <div class="pinned" id="hero-scroll-pinned">
      ...
      <!-- Arrow callouts overlaid on screenshot -->
      <div class="callouts">
      ...
      <!-- Feature copy strip below screenshot -->
...
<style>
  ...
  .logo-wrap {
    ...
    border-radius: 32px; border: 1.5px solid rgba(255,255,255,0.35);
  ...
  .eyebrow {
    ...
    color: rgba(0,0,0,0.35); margin: 0 0 1rem 0;
  }
  .headline {
    font-family: 'Newsreader', Georgia, serif; font-size: clamp(2.8rem, 6vw, 4.5rem);
    font-weight: 400; line-height: 1.15; letter-spacing: -0.03em;
    color: rgba(0,0,0,0.88); max-width: 700px; margin: 0 0 2rem 0;
  }
  ...
  .intro-desc {
    max-width: 520px; font-size: 1.1rem; line-height: 1.7;
    color: rgba(0,0,0,0.5); margin: 0 0 1.5rem 0;
  }
  .intro-hint {
    font-family: 'Inter', sans-serif; font-size: 0.8rem; color: rgba(0,0,0,0.4);
    letter-spacing: 0.05em; margin: 0 0 2.5rem 0;
    animation: pulse-hint 2s ease-in-out infinite;
  }
  .intro-trust {
    display: flex; flex-wrap: wrap; justify-content: center; gap: 1.25rem;
    padding-top: 1.5rem; border-top: 2px solid;
  ...
  @keyframes pulse-hint { 0%, 100% { opacity: 0.4; } 50% { opacity: 0.7; } }
  ...
  /* --- Screenshot --- */
  .screenshots { position: relative; width: min(88vw, 960px); aspect-ratio: 8 / 5; }
  .shot {
  ...
  /* --- Copy strip --- */
  .copy-strip {
    position: relative; width: min(88vw, 960px); min-height: 60px;
  }
  .copy-block {
  ...
  .copy-subtitle {
    ...
    color: rgba(0,0,0,0.5); line-height: 1.6; margin: 0; max-width: 600px;
  }
  .tag-list { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 10px; justify-content: center; }
  .tag {
    border-radius: 9999px; padding: 3px 11px; font-size: 12px;
    font-family: 'Inter', sans-serif; font-weight: 500;
  }
  .tag--blue {
    background: rgba(59,130,246,0.08); border: 1px solid rgba(59,130,246,0.2); color: #2563eb;
  }
  ...
  .dot {
    ...
    background: rgba(0,0,0,0.2); transition: transform 0.25s ease;
  }

  /* --- CTA --- */
  .cta-section {
    display: flex; justify-content: center;
    padding: 6rem 2rem 7rem; background: #f5f4f1;
  }
  ...
  @media (max-width: 767px) {
    ...
    .screenshots { width: 100%; aspect-ratio: auto; }
