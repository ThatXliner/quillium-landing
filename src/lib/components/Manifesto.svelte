...
<section id="manifesto" class="px-8 text-center">
	<div class="reveal mx-auto mt-20 max-w-[800px]">
		<h1 class="section-eyebrow section-eyebrow--centered">The Manifesto</h1>
		...
		<p class="mb-8 text-[1.05rem] leading-relaxed text-black/28 contrast-more:text-black/55">
		...
		<div class="mb-10 grid grid-cols-1 gap-5 text-left md:grid-cols-2">
			<div
				class="gap-2 rounded-xl bg-white/50 p-8 shadow-md inset-shadow-sm inset-shadow-white backdrop-blur-md transition-colors"
			>
