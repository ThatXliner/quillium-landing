...
Imagine it notices when a verb is working too hard and asks "is that what you want?" rather than just swapping it out. Imagine it flags when you've started three consecutive paragraphs with the same construction, or catches a tone shift mid-essay and asks if it was intentional.
...
Quillium is a writing tool first. The core experience—non-linear editing, branching, revision—doesn't need AI and works fine without it. AI is an add-on for people who actively want it, not a default that people have to actively escape. You'll never open your editor and find generated text you didn't ask for. When you enable it, you know what you're getting: a reader, not a co-writer. If you want it, flip the switch. If you don't, nothing changes.
