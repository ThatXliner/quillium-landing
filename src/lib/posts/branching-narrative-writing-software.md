...
**Twine** is probably the closest thing to branching writing software that exists today. It was built for interactive fiction—the choose-your-own-path kind of stories—and it does that well, with nodes connected by links and a graph of narrative paths you can walk through. Twine is designed for the reader's branching experience, though, rather than the writer's. You're authoring a final product that branches, not exploring multiple drafts of the same passage.
...
This is exactly the problem I'm working on with **Quillium**. The core idea is that writing is non-linear, so your writing tool should be too, and you should be able to fork a sentence the way a developer forks a branch: instantly, without ceremony, and without losing anything.

I'm not building Twine for novelists or Git with a pretty face. I'm building a writing environment where branching is natural enough that you don't think about it, where exploring an alternative phrasing is as easy as typing it, and where both versions just exist. Keyboard first!

Writing is already non-linear in your head, and it's time your tools caught up. If any of this resonates, [try it out](/#download).
