...
This is how almost every writing app works. Google Docs, Word, Notion, even most "distraction-free" editors. They all share the same assumption that writing is linear. You begin, you continue, you finish.
...
Outliners like Roam Research and Obsidian are closer. They let you link ideas bidirectionally, nest thoughts, and build a graph of connected notes, which makes them great for *research* and *note-taking*. But when it's time to actually write—to turn those atomic notes into a cohesive piece—you're back to a linear document. The non-linearity stops at the outline level.
...
It's writing with the freedom to think non-linearly *while* you write, not just before or after. The goal isn't to add complexity; the goal is to finally match the tool to the way your brain already works. Writing is revision, revision is exploration, and exploration, by its nature, branches.
